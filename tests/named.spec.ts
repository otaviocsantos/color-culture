...
describe('Named tests', () => {

    it('Should return a color\'s name by its value ', () => {
        const name = Named.getName('#FF0000');
        expect(name).to.equal('red');
    });

    it('Should return a color\'s name by its value ', () => {
        const name = Named.getName('#00000000');
        expect(name).to.equal('transparent');
    });

    it('Should return a color\'s name by its value ', () => {
        const value = Named.getValue('transparent');
